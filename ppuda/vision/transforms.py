...
class Noise:
    def __init__(self, noise_std=0.08):
        ...
        :param noise_std: default is 0.08 for CIFAR-10 and 0.18 for ImageNet. The values are according to medium noise
                          severity from https://github.com/hendrycks/robustness. "Dan Hendrycks, Thomas Dietterich.
