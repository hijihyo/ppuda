...
from torchvision.datasets import *  # noqa: F401
...
def image_loader(
    ...
    :param cutout: use Cutout for data augmentation from "Terrance DeVries, Graham W. Taylor. Improved Regularization of
    ...
    :param n_shots: the number of training images per class (only for CIFAR-10 and other torchvision datasets and when
                    test=True)
